...
```{r}
de_nation <- read_sf(dsn = "https://github.com/ubt-r/geodatenbearbeitung/raw/refs/heads/main/de_nation.geojson") # Einlesen von GEOJSON-Datei
```
...
#| eval: false
#| echo: false
# Prepare data for upload to GitHub
# POLYGON: Sachsen
...
#| warning: false
# POLYGON: Sachsen
sachsen <- read_sf("https://github.com/ubt-r/geodatenbearbeitung/raw/refs/heads/main/sachsen.geojson")
# MULTIPOLYGON: Bundesländer
de_states <- read_sf("https://github.com/ubt-r/geodatenbearbeitung/raw/refs/heads/main/de_states.geojson")
# POINT: Berlin
berlin <- read_sf("https://github.com/ubt-r/geodatenbearbeitung/raw/refs/heads/main/berlin.geojson") 
# MULTIPOINT: Ausgewählte Städte
de_cities <- read_sf("https://github.com/ubt-r/geodatenbearbeitung/raw/refs/heads/main/de_cities.geojson") 
# LINESTRING: E41 nahe Worms
e31_worms <- read_sf("https://github.com/ubt-r/geodatenbearbeitung/raw/refs/heads/main/e41_worms.geojson")
# MULTILINESTRING: Ausgewählte Straßen
de_roads <- read_sf("https://github.com/ubt-r/geodatenbearbeitung/raw/refs/heads/main/de_roads.geojson")
```
...
1. Laden Sie die [Geodaten](https://github.com/ubt-r/geodatenbearbeitung/blob/main/de_districts.geojson) aller deutschen Kreise und kreisfreien Städte im GeoJSON-Format herunter. Importieren Sie die Geodaten mit `read_sf()` in Ihre R-Sitzung und weisen Sie den Inhalt einem Objekt namens `de_districts` zu. Zeichnen Sie die Geodaten mit `ggplot()`.
...
3. Laden Sie die [thematischen Daten](https://github.com/ubt-r/geodatenbearbeitung/blob/main/de_kreise_sgb2_u18.rds) herunter und importieren Sie sie mit `read_rds()`.
